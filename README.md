...
- **边缘情绪计算**：端侧 RandomForest 模型实时分类 6 类情绪（平静/愉悦/微沮丧/中沮丧/强沮丧/焦虑）
...
- **模型**：RandomForest (52 维特征)
- **推理平台**：K1 CPU（端侧推理，无需云端）
- **分类类别**：calm / pleasure / frustration1 / frustration2 / frustration3 / anxiety
- **特征维度**：呼吸变异性 + 心率变异性 + 姿态稳定性 + 疲劳指标
